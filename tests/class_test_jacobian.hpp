 ...
 public:
  test_split_sparse_Jacobian(const std::string& file_path, std::size_t function_cost){
...

    {
      ...
      Sparse_Jacobian lhs = 
        Sparse_Jacobian::from_file("./sparse_jacobian_sample_tests/case_1_MxM_lhs_sparse_data");

      Split_sparse_Jacobian split_sparse_lhs{lhs, function_cost_lhs};
      
      Sparse_Jacobian rhs =
        Sparse_Jacobian::from_file("./sparse_jacobian_sample_tests/case_1_MxM_rhs_sparse_data");
