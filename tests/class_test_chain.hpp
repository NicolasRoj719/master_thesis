...
class test_chain<Split_dense_Jacobian, Split_reversal_dense_information>{
 public:
  test_chain(const std::string& case_name){
    ...
    const std::string functions_cost_path = "./chain_test_cases/" + case_name + "_functions_cost";
    ...
    {
      const std::string file_path = "./chain_test_cases/"+ case_name + "_matrix_free";
...
class test_chain<Split_sparse_Jacobian, Split_reversal_sparse_information>{
 public:
  test_chain(const std::string& case_name){
    ...
    //Testing chain constructed from file.
    {
      const std::string file_path = "./chain_test_cases/"+ case_name + "_sparse";
